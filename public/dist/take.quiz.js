...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('quiz-component', {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('loading-component', {
    template: '#loading-template',
})
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('error-response-component', {
    template: '#error-response-template',
    props: ['msg']
})

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('success-response-component', {
    template: '#quiz-submission-template',
    props:['result']
});

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('meta[name="csrf_token"]').getAttribute('content'); //add token;
